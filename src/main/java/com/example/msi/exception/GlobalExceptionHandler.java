...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleUsuarioException(UsuarioException ex) {
        ...
        } else if (ex instanceof UsuarioException.UsuarioInativoException) {
    ...
    public ResponseEntity<Map<String, String>> handleUsuarioValidationException(UsuarioValidationException ex) {
        Map<String, String> errors = new HashMap<>();
        errors.put("error", ex.getMessage());
